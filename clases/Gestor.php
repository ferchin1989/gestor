<?php 	
   ...
   require_once "Conexion.php";
    ...
    class Gestor extends Conectar
    {
        ...
        {
            $conexion = Conectar::conexion();
            $sql = "SELECT DISTINCT nombre FROM t_archivos WHERE id_archivo ='$idArchivo'";
        ...
        public function tipoArchivo($nombre,$extension)
        {
           ...
           $ruta = "../ArchivosImagenes/".$idUsuario."/".$nombre;
           ...
           switch ($extension) {
               ...
               case 'pdf':  
                   return '<embed src="'.$ruta.'#toolbar=0&scrollbar=0" type="application/pdf" width="100%" heigth="800p" />';
                   break;
